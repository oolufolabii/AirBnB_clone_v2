#!/usr/bin/python3
"""Definition of a class to manage database storage for AirBnb clone"""
import os
...
class DBStorage:
    """Class creation for the SQL storage model
    """
    ...
    def __init__(self):
        """Initialize the SQL storage parameters"""
        ...
        DATABSE_URL = "mysql+mysqldb://{}:{}@{}:3306/{}".format(
            user, pword, host, db_name)

        self.__engine = create_engine(DATABSE_URL, pool_pre_ping=True)
    ...
    def all(self, cls=None):
        ...
        if cls is None:
            for class_type in model_classes:
